...
## ----message=FALSE, warning=FALSE, fig.width=8, fig.height=total_fig_height(iris)----
iris %>% 
  explore_all()

## ----message=FALSE, warning=FALSE, fig.width=8, fig.height=total_fig_height(iris, target = Species)----
